...
from datasets import ycb_hdf5_reconstruction_dataset_new_keras
...
def get_model():
    ...
    model.add(Dense(output_dim=3000, init='normal', activation='linear'))
    # output: a vector of size 4000
    model.add(Dense(output_dim=4000, init='normal', activation='linear'))
    # output: a vector of size PATCH_SIZE*PATCH_SIZE*PATCH_SIZE
    model.add(Dense(output_dim=PATCH_SIZE * PATCH_SIZE * PATCH_SIZE,
...
def get_dataset():
    ...
    # dataset = ycb_reconstruction_dataset.YcbDataset(
    #   "/srv/data/shape_completion_data/ycb/",
    #   "rubbermaid_ice_guard_pitcher_blue", PATCH_SIZE)
    # dataset = hdf5_reconstruction_dataset.ReconstructionDataset(
    #   '/srv/data/shape_completion_data/ycb/wescott_orange_grey_scissors/h5/' +
    #   'wescott_orange_grey_scissors.h5')
    ...
    dataset = ycb_hdf5_reconstruction_dataset_new_keras.YcbReconstructionDatasetNewKeras(
        '/srv/data/shape_completion_data/ycb/',
        model_names)
    return dataset
