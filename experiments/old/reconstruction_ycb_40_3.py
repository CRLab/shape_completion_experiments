...
def get_model():
    ...
    # output: 64 cubes of side length 16-5+1 = 12
    model.add(Convolution3D(nb_filter=nb_filter_out,
                            stack_size=nb_filter_in,
                            nb_row=filter_size,
                            nb_col=filter_size,
    ...
    # output: 64 cubes of side length 12-8+1 = 5
    model.add(Convolution3D(nb_filter=nb_filter_out,
                            stack_size=nb_filter_in,
                            nb_row=filter_size,
                            nb_col=filter_size,
    ...
    model.add(Flatten())
    model.add(Dense(nb_filter_out * dim * dim * dim, 8000, init='he_normal', activation='relu'))

    model.add(Dense(8000, 1000, init='he_normal', activation='relu'))

    model.add(Dense(1000, PATCH_SIZE * PATCH_SIZE * PATCH_SIZE, init='glorot_normal',
                    activation='sigmoid'))
