...
def get_model():
    ...
    model.add(Convolution3D(nb_filter=nb_filter_out, stack_size=nb_filter_in,
                            ...
                            nb_depth=filter_size, border_mode='valid', activation='leaky_relu', init='he_normal'))
    ...
    model.add(Flatten())
    n_out = 4000
    model.add(Dense(nb_filter_out * dim * dim * dim, n_out, activation='leaky_relu', init='he_normal'))
