...
def get_model():
    ...
    # output: 64 cubes of side length 18-4+1 = 15
    model.add(Convolution3D(nb_filter=nb_filter_out,
                            stack_size=nb_filter_in,
                            nb_row=filter_size,
                            nb_col=filter_size,
    ...
    # output: 64 cubes of side length 7-3+1 = 5
    model.add(Convolution3D(nb_filter=nb_filter_out,
                            stack_size=nb_filter_in,
                            nb_row=filter_size,
                            nb_col=filter_size,
    ...
    model.add(Flatten())
    model.add(Dense(nb_filter_out * dim * dim * dim, 4000, init='normal', activation='relu'))
    model.add(Dense(4000, 5000, init='normal', activation='relu'))
    model.add(Dense(5000, PATCH_SIZE * PATCH_SIZE * PATCH_SIZE, init='normal',
                    activation='sigmoid'))
