...
from utils.reconstruction_utils import map_pointclouds_to_camera_frame, build_training_example, build_training_example_scaled
...
class YcbDataset():
    ...
    def __init__(self,
        ...
        self.pc_dir = data_dir + '/' +  model_name + '/pointclouds_yaw/'
...
if __name__ == "__main__":
    dataset = YcbDataset("/srv/data/shape_completion_data/ycb/", "wescott_orange_grey_scissors", 30)
